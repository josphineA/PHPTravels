...
public class PHPHomePage {
	...
	public static void main(String[] args) throws InterruptedException{
		...
		//WebElement htlsearch= driver.findElement(By.className("select2-input"));
		
//		WebElement htlsearch= driver.findElement(By.xpath("//div[contains(@class,'select2-input')]"));
//		htlsearch.sendKeys("Oasis Beach Tower");
		
//		WebElement htlsearch= driver.findElement(By.xpath("//span[contains(@class,'select2-chosen')]"));
		
//		WebElement htlsearch= driver.findElement(By.className("select2-chosen"));
//		htlsearch.sendKeys("Oasis Beach Tower");	
		
		WebElement htlsearch= driver.findElement(By.id("s2id_autogen2"));
		htlsearch.sendKeys("Oasis Beach Tower");		
